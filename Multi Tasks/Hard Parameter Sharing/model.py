...
class MTLmodel(nn.Module):
  ...
  def __init__(self,n_classes1,n_classes2,pretrained_model):
    ...
    self.relu = nn.ReLU()
    self.sent = nn.Linear(128,n_classes1)
    self.off = nn.Linear(128,n_classes2)
  ...
  def forward(self, input_ids, attention_mask):
    ...
    return self.sent(pooler), self.off(pooler)